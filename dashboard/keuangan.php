        ...
        <div class="modal-container bg-white w-11/12 md:w-1/3 mx-auto rounded-lg shadow-lg">
            ...
            <div class="modal-body p-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="modalDatePicker" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 h-12 px-3 py-2" placeholder="Pilih Tanggal" name="tanggal" required>
                </div>
                <div class="mb-4">
                    <label for="kode" class="block text-sm font-medium">Kode</label>
                    <input type="text" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 h-12 px-3 py-2" id="kode" name="kode" required>
                </div>
                <div class="mb-4">
                    <label for="dropdown" class="block text-sm font-medium">Reff</label>
                    <select id="dropdown" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 h-12 px-3 py-2" required>
                ...
                <div class="mb-4" id="debitBox" style="display: none;">
                    ...
                    <input type="text" id="debitTextbox" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 h-12 px-3 py-2" placeholder="Detail debit">
                </div>
                <div class="mb-4" id="kreditBox" style="display: none;">
                    <label for="kreditTextbox" class="block text-sm font-medium">Kredit</label>
                    <input type="text" id="kreditTextbox" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 h-12 px-3 py-2" placeholder="Detail kredit">
                </div>
                <div class="mb-4">
                    <label for="keterangan" class="block text-sm font-medium">Keterangan</label>
                    <textarea id="keterangan" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 px-3 py-2" placeholder="Isi keterangan" rows="4" required></textarea>
                </div>
